...
export default class listExpenses extends Component {
    ...
    renderExpenses() {
        let filteredContacts = this.state.expenses.filter(expenseSearch => {
            return expenseSearch.expense_date.indexOf(this.state.search) !== -1;
        });
        return (
            <div>
